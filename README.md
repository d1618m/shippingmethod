...
- [app/code/<vendor_name>/<module_name>/registration.php](https://github.com/kgkrunch/shippingmethod/registration.php)
- [app/code/<vendor_name>/<module_name>/etc/module.xml](https://github.com/kgkrunch/shippingmethod/etc/module.xml)
